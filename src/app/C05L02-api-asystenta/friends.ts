...
export const friendsShort = {
  zygfryd: {
    Nagrody_i_wyróżnienia: [
      "Podczas ostatniej konferencji technologicznej, program stworzony przez Zygfryda zdobył nagrodę za innowacyjność w użyciu JavaScript.",
      "W lokalnym maratonie programistycznym aplikacja mobilna zaprojektowana przez Zygfryda zdobyła pierwsze miejsce.",
    ],
    Zainteresowania: [
      "Programowanie",
      "Muzyka (gra na ukulele)",
      "Hodowla roślin doniczkowych",
      "Łamigłówki logiczne",
      "Gry planszowe (ulubiona to 'Terra Mystica')",
      "Ulubiony film to 'Matrix'",
      "Podróże (piesze wędrówki, Instagram z podróży po górach)",
      "Stand-up comedy",
      "Modelarstwo (model statku kosmicznego 'Enterprise')",
      "Fotografia",
      "Enologia",
      "Weselny taniec to klasyczne tango",
    ],
    Osobiste_achievmenty: [
      "Był mistrzem ortografii w szkole podstawowej",
      "Bierze udział w konkursach łamigłówek logicznych i osiąga wysokie lokaty",
      "Zajął miejsce w pierwszej dziesiątce na półmaratonie w swoim mieście",
      "Został mistrzem ortografii w szkole podstawowej",
    ],
    Hobby: [
      "Ukulele",
      "Hodowla roślin doniczkowych (posiada rzadki gatunek storczyka)",
      "Łamigłówki logiczne",
      "Gry planszowe ('Terra Mystica')",
      "Modelarstwo (model statku kosmicznego 'Enterprise')",
      "Fotografia",
      "Enologia",
    ],
    Umiejętności_programistyczne: [
      "JavaScript (zwycięski program na konferencji technologicznej)",
      "Vue.js (jeden z pierwszych programistów w Polsce, którzy go używali)",
      "Certyfikaty z kilku innych języków programowania",
      "Tworzenie własnych bibliotek języka JavaScript",
      "Praca dla małych start-upów i wielkich korporacji IT",
      "Stworzenie otwartej platformy edukacyjnej",
      "Praca nad sztuczną inteligencją i etycznymi algorytmami",
    ],
    Inne: [
      "Biegła znajomość języka migowego",
      "Lojalność do open-source'owych projektów",
      "Współtworzenie startupu technologicznego",
      "Organizacja warsztatów kodowania dla dzieci",
      "Konstruowanie dronów",
      "Tłumaczenie dokumentacji technicznej na polski",
      "Znajomość trendów w projektowaniu interfejsów użytkownika",
      "Mentorstwo programistyczne",
      "Regularne publikowanie wskazówek dla początkujących programistów na blogu o JavaScript",
      "Badanie nowych sposobów wykorzystania wirtualnej rzeczywistości w edukacji programistycznej",
      "Udział w organizacjach charytatywnych",
      "Udział w wykopaliskach archeologicznych",
      "Recenzowanie książek przed ich wydaniem",
      "Zaskakujące sztuczki karciane",
    ],
  },
  stefan: {
    Hobby: [
      "Organizacja konkursów na zjedzenie hot doga w sklepie",
      "Ćwiczenia na siłowni",
      "Eksperymentowanie z nowymi przepisami na hot dogi",
      "Tworzenie bloga o treningach na biceps",
      "Udział w festiwalach kulinarnych",
      "Uczestnictwo w maratonach filmowych",
      "Pomaganie w organizacji eventów sportowych",
    ],
    Zainteresowania: [
      "Tworzenie hot dogów",
      "Kulturystyka",
      "Pomoc zwierzętom (dochód ze sprzedaży hot dogów na schronisko)",
      "Żeglarstwo",
    ],
    Osobiste_osiągnięcia: [
      "Wygrana w konkursach jedzenia hot dogów w szkole",
      "Trzecie miejsce w amatorskich zawodach kulturystycznych",
      "Kilkukrotne zdobycie tytułu 'Sprzedawcy Miesiąca' w sieci sklepów Żabka",
      "Urządzenie najdłuższego hot doga w mieście",
    ],
    Umiejętności: [
      "Wyciskanie sztangi o masie własnego ciała",
      "Mieszanie unikalnych przypraw do hot dogów",
      "Szybkie pakowanie zakupów w sklepie",
      "Nauka treningu początkujących na siłowni",
      "Szybkie liczenie pieniędzy w kasie",
      "Kompilowanie przepisów kulinarnych na hot dogi deluxe",
      "Tworzenie papierowych ozdób dla produktów hot dogowych",
      "Utrzymywanie bliskich relacji z klientami",
    ],
    Inne: [
      "Pracuje w sklepie Żabka",
      "Pomoc w miejscowych wydarzeniach charytatywnych",
      "Udzielenie porad na temat zdrowego stylu życia",
      "Organizowanie konkursów dla klientów w sklepie",
      "Posiadanie certyfikatu pierwszej pomocy",
      "Uczestnictwo w konkursach jedzących hot dogi",
      "Utrzymanie balansu pomiędzy pracą a treningami",
      "Udzielanie porad na lokalnym forum internetowym dotyczącym zdrowia i treningów",
    ],
  },
  ania: {
    Nagrody_i_wyróżnienia: [
    ...
    Zainteresowania: [
      "Prawo (szczególnie prawo autorskie)",
      "Beauty (prowadzenie kanału na YouTube)",
      "Fitness (starty w zawodach fitness bikini)",
      "Kulinaria",
      "Samoobrona (organizacja warsztatów dla kobiet)",
      "Narciarstwo",
      "Literatura (legal thriller)",
      "Taniec",
      "Języki obce (francuski, hiszpański)",
      "Muzyka",
      "Sztuka (tatuaż, szydełkowanie)",
      "Gry szachowe",
    ],
    Osobiste_achievmenty: [
      "Wykazanie się umiejętnościami podczas wyścigów Porsche Club",
      "Sukcesy w konkursach fitness",
      "Zaangażowanie w wolontariat w lokalnym centrum praw kobiet",
      "Przemówienie na temat praw kobiet, cieszące się dużym zainteresowaniem publiczności",
    ],
    Hobby: [
      "Taniec",
      "Fitness",
    ...
    Umiejętności_prawne: [
      "Organizacja konferencji prawniczych",
      "Praktyki w renomowanej kancelarii prawnej",
      "Członkostwo w zarządzie koła naukowego prawa karnego",
      "Staż w Paryżu, by zgłębiać prawo francuskie",
      "Prowadzenie warsztatów z samoobrony dla kobiet",
      "Udział w projekcie Budowanie Silnych Marki Osobistej",
    ],
    Inne: [
      "Jennifer Lopez to inspiracja fitnessowa",
      "Znajomość języków obcych (francuski, hiszpański)",
      "Prenumerowanie boksów z kosmetykami",
      "Biegła znajomość fitness bikini",
      "Udział w projekcie publikacji na temat cyberbezpieczeństwa",
      "Udzielenie korepetycji z prawa konstytucyjnego",
      "Udział w rozgrywkach szachowych na uczelni",
    ],
  },
};
